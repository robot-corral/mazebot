...
print()
print(f'extern const uint32_t g_dmaTimerDataIncreasing[(DMA_TIMER_STEPS_COUNT + 1) * 3];')
print(f'extern const uint32_t g_dmaTimerDataDecreasing[(DMA_TIMER_STEPS_COUNT + 2) * 3];')
print()
...
print('};')
print()
print(f'const uint32_t g_dmaTimerDataDecreasing[(DMA_TIMER_STEPS_COUNT + 2) * 3] = {{')
for i in range(1, stepsCount + 1):
