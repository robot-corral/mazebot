...
void initializeSdPins()
{
    ...
    LL_GPIO_SetPinSpeed(GPIOD, LL_GPIO_PIN_10, LL_GPIO_SPEED_FREQ_HIGH);
    LL_GPIO_SetAFPin_8_15(GPIOC, LL_GPIO_PIN_10, LL_GPIO_AF_12);

    LL_GPIO_SetPinMode(GPIOC, LL_GPIO_PIN_11, LL_GPIO_MODE_ALTERNATE);
    LL_GPIO_SetPinSpeed(GPIOD, LL_GPIO_PIN_11, LL_GPIO_SPEED_FREQ_HIGH);
...
void initializeSpiPins()
{
    ...
    LL_GPIO_SetPinSpeed(GPIOD, LL_GPIO_PIN_10, LL_GPIO_SPEED_FREQ_VERY_HIGH);
